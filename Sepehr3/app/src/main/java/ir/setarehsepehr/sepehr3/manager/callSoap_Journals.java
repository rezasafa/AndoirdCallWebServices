...
public class callSoap_Journals {
    public callSoap_Journals(){}

    public String Call(Context context,String co, String y, String AccQuery, String StartDate, String EndDate, String TafsilNo){
        sVar c = new sVar();
        String SOAP_ACTION = c.Get_WSDL_TARGET_NAMESPACE() + c.Get_Operator_Journals();
        String OPERATION_NAME = c.Get_Operator_Journals();
