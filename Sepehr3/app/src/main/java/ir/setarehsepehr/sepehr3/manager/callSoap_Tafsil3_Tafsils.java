...
public class callSoap_Tafsil3_Tafsils {
    public callSoap_Tafsil3_Tafsils(){}
    public String Call(Context context, String co, String y ,String TafsilNo){
        sVar c = new sVar();
        String SOAP_ACTION = c.Get_WSDL_TARGET_NAMESPACE() + c.Get_Operator_Get_Tafsil3_Tafsils();
        String OPERATION_NAME = c.Get_Operator_Get_Tafsil3_Tafsils();
