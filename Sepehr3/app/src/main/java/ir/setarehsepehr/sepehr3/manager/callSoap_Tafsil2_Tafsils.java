...
public class callSoap_Tafsil2_Tafsils {
    public callSoap_Tafsil2_Tafsils(){}
    public String Call(Context context, String co, String y ,String TafsilNo){
        sVar c = new sVar();
        String SOAP_ACTION = c.Get_WSDL_TARGET_NAMESPACE() + c.Get_Operator_Get_Tafsil2_Tafsils();
        String OPERATION_NAME = c.Get_Operator_Get_Tafsil2_Tafsils();
