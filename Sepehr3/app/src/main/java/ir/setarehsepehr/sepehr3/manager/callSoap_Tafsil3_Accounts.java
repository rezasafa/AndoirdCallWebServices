...
public class callSoap_Tafsil3_Accounts {
    public callSoap_Tafsil3_Accounts(){}
    public String Call(Context context, String co, String y ,String Acc_No){
        sVar c = new sVar();
        String SOAP_ACTION = c.Get_WSDL_TARGET_NAMESPACE() + c.Get_Operator_Get_Tafsil3_Accounts();
        String OPERATION_NAME = c.Get_Operator_Get_Tafsil3_Accounts();
